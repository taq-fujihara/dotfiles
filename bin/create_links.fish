...
create_link config/herdr/config.toml .config/herdr/config.toml
create_link config/hunk/config.toml .config/hunk/config.toml
...
create_link config/zed/tasks.json .config/zed/tasks.json
